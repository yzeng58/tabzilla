...
ALG_TYPES = {
    ...
    "XGBoost": "GBDT",
    "CatBoost": "GBDT",
    "DecisionTree": "Classical",
    "LinearModel": "Classical",
    "KNN": "Classical",
    "SVM": "Classical",
    "RandomForest": "Classical",
    'TabFlexH1K': "TF",
    'TabFlexL100': "TF",
    'TabFlexH5K': "TF",
    'TabFlexS100': "TF",
...
ALG_DISPLAY_NAMES = {
    ...
    "TabFlexH1KModel": "TabFlexH1K",
    "TabFlexH5KModel": "TabFlexH5K",
    'TabFlexL100Model': 'TabFlexL100',
    'TabFlexS100Model': 'TabFlexS100',
    "TabLinearModel": "TabLinear",
    "TabSoftCappingModel": "TabSoftCapping",
    "TabSlidingModel": "TabSliding",
    "TunetablesModel": "TuneTables",
    "HyperFastModel": "HyperFast",
    "LightGBM": "LightGBM",
    "XGBoost": "XGBoost",
    "CatBoost": "CatBoost",
